...
public class GProxy 
{
    ...
    /**
     * Creates a proxy object using <code>java.lang.reflect.Proxy</code> based on the provided Groovy object and the classes of the implemented Java interfaces.
     * 
     ...
     * the original object provided. Methods called in proxy object are received by <code>GProxy</code> and forwarded to the original object, if source code
     ...
     * 
     * <p>If <code>GProxy</code> is disabled returns the original object provided with no performance penalty.</p>
     * 
     * @param obj the original object to proxy.
