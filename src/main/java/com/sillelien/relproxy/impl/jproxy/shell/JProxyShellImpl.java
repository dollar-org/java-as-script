package com.sillelien.relproxy.impl.jproxy.shell;
...
public abstract class JProxyShellImpl extends JProxyImpl
{
    ...
    public static void main(String[] args)
    {
        if (args[0].isEmpty()) 
        {
            // Esto tiene explicación: cuando invocamos jproxysh sin parámetros (o espacios da igual) invocamos dentro jproxysh con com.sillelien.relproxy.jproxy.JProxyShell "$@"
